 ...
 *
 * The device table is a list of up up to 16 entries. Each entry specifies a range
 ...
 * memory-mapped device I/O or should be marked as "cache-disable". This is done
